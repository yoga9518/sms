                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-body">
                            ...
                            <a href="<?php echo base_url();?>index.php/admin/c_admin/pesan_masuk" class="btn btn-primary ">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $dt) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url()."index.php/admin/c_admin/balas/".$dt['ID']; ?>" class="btn btn-primary btn-circle"><i class="fa fa-edit"></i></a>
                                                <a  href="<?php echo base_url()."index.php/admin/c_admin/hapus_inbox/".$dt['ID']; ?>" class="btn btn-danger btn-circle" onclick="return confirm ('Apakah Anda Ingin Menghapus Pesan Untuk <?php echo $dt['SenderNumber'];?>')"><i class="fa fa-times"></i></a>
