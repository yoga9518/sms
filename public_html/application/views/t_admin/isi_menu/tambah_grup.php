                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <form onsubmit="return cekform();" action="<?php echo base_url() ?>index.php/admin/c_admin/dotambahgrup" method="post">
                                <div class="form-group">
                                    <label class="col-lg-3 col-sm-3 control-label">Nama Group</label>
                                    <div class="col-lg-4">
                                        <input class="form-control" id="nama" name="nama" type="text" placeholder="Nama Group" >
                                    </div>
                                </div>
                                <br>
