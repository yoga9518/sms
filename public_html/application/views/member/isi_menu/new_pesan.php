                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <form onsubmit="return cekform();" action="<?php echo base_url() ?>index.php/member/c_member/kirim_pesan" method="post">
                                <div class="form-group">
                                    <label class="col-lg-3 col-sm-3 control-label" for="disabledSelect">Nomor Telepon</label>
                                    <div class="col-lg-4">
                                        <input class="form-control" id="nohp" name="nohp" type="text" placeholder="Nomor Telepon" >
                                    </div>
                                </div>
                                <br>
                                <br>
