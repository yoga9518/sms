                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-body">
                            ...
                            <a href="<?php echo base_url();?>index.php/admin/c_admin/tambah_grup">
                                    ...
                                    foreach ($data as $dt) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- <a href="dsdf" class="btn btn-danger btn-circle" onclick="return confirm('Apakan anda ingin menghapus <?php //echo $dt['NameGroup'] ?>')"><i class="fa fa-times"></i></a> -->
                                                
                                                <a class="btn btn-primary" href="<?php echo base_url()."index.php/admin/c_admin/editgrup/".$dt['GroupID']; ?>"><i class="fa fa-edit"></i> Edit</a>
                                                <a class="btn btn-danger" href="<?php echo base_url()."index.php/admin/c_admin/deletegrup/".$dt['GroupID'];?>" onclick="return confirm ('Apakah Anda Ingin Menghapus <?php echo $dt['NameGroup'] ?>')"><i class="fa fa-trash-o"></i> Hapus</a>
