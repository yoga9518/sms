                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-body">
                            ...
                            <a href="<?php echo base_url();?>index.php/admin/c_admin/pesan_keluar" class="btn btn-primary ">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $dt) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-danger" href="<?php echo base_url()."index.php/admin/c_admin/hapus_outbox/".$dt['ID']; ?>" onclick="return confirm ('Apakah Anda Ingin Menghapus Pesan Untuk <?php echo $dt['DestinationNumber'];?>?')"><i class="fa fa-trash-o"></i> Hapus</a>
                        ...
                        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="delete-data" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url()."index.php/admin/c_admin/hapus_outbox/".$dt['ID']; ?>" method="post" enctype="multipart/form-data" role="form">
                                        <div class="modal-header">
