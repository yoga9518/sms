                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-body">
                            ...
                            <a href="<?php echo base_url();?>index.php/member/c_member/tambah_pbk">
                                <button class="btn btn-success btn-sm" >
                                    Tambah 
                                </button>
                            </a>
                                <!-- <a href="<?php //echo base_url();?>index.php/member/c_member/new_pesan">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $dt) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-circle" href="<?php echo base_url()."index.php/member/c_member/editpbk/".$dt['ID']; ?>" ><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-danger btn-circle" href="<?php echo base_url()."index.php/member/c_member/deletepbk/".$dt['ID']; ?>"onclick="return confirm ('Apakah Anda Ingin Menghapus Phonebook <?php echo $dt['Name'];?>')"><i class="fa fa-times"></i></a>
                        ...
                        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="delete-data" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url() . "index.php/member/c_member/delete/" . $dt['id']; ?>" method="post" enctype="multipart/form-data" role="form">
                                        <div class="modal-header">
