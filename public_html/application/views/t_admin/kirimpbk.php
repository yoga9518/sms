                        ...
                        <div class="panel-body">
                            ...
                            <form onsubmit="return cekform();" action="<?php echo base_url() ?>index.php/admin/c_admin/kirim_pesan" method="post">
                                <div class="form-group">
                                    <label class="col-lg-3 col-sm-3 control-label" >Nomor Telepon</label>
                                    <div class="col-lg-4">
                                        <input class="form-control" id="nohp" name="nohp" type="hidden" value="<?php echo $dt->Number ?>">
                                        <input class="form-control" type="hidden" value="<?php echo $dt->Name ?>">
                                        <input class="form-control" id="nohp" name="nohp" type="text" value="<?php echo $dt->Number ?>" disabled>
                                    </div>
                                </div>
                                <br>
                                <br>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input class="form-control" value="<?php echo $dt->Name ?>" disabled>
                                    </div>
                                </div>
                                <br><br>
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control" rows="6" placeholder="Isi Pesan" disabled><?php echo $dt->TextDecoded; ?></textarea>
                                    </div>
                                </div>
                                <br><br>
                                <br><br> -->
                                ...
                                <div>
                                    ...
                                    <div class="col-lg-6" align="left">
                                        ...
                                        <a class="btn btn-default" href="<?php echo base_url();?>index.php/admin/c_admin/pesan_masuk"> Batal</a>
                                    </div>
                                </div>
                            </form>
                        </div>
